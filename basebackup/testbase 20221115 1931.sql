...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Ответы на вопросы тестов';
...
INSERT INTO `questiontype` (`type`,`limit`,`score`,`description`) VALUES 
 ('checkbox',8,2,'Пользователю предоставляется 8 вариантов ответа на вопрос, каждый из которых может быть верным. Число верных ответов: от 1 до 8.'),
