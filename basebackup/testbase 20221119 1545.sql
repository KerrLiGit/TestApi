...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Ответы на вопросы тестов';
...
INSERT INTO `answer` (`answerid`,`questionid`,`content`,`correct`) VALUES 
 ...
 (12,3,'Текстовый твет',1),
 (13,3,'Верный текстовый твет',1);
...
CREATE TABLE `profile` (
  ...
  PRIMARY KEY (`userid`),
  UNIQUE KEY `Index_2` (`login`) USING BTREE,
  UNIQUE KEY `Index_3` (`password`) USING BTREE,
  CONSTRAINT `FK_profile_1` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Логин и пароль пользователя для входа на сайт';
...
INSERT INTO `profile` (`userid`,`login`,`password`) VALUES 
 (6,'user','ee11cbb19052e40b07aac0ca060c23ee'),
 (7,'user7','3e0469fb134991f8f75a2760e409c6ed');
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Вопросы тестов';
...
INSERT INTO `question` (`questionid`,`name`,`testid`,`content`,`type`) VALUES 
 ...
 (7,'Вопрос с текстовым ответом',2,'Содержание текстового вопроса','text');
