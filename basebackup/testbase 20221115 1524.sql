...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Ответы на вопросы тестов';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Вопросы тестов';
...
INSERT INTO `questiontype` (`type`,`limit`,`score`,`description`) VALUES 
 ('checkbox',8,1,'Пользователю предоставляется 8 вариантов ответа на вопрос, каждый из которых может быть верным. Число верных ответов: от 1 до 8.'),
 ('radio',4,2,'Пользователю предоставляется 4 варианта ответа на вопрос, из которых только 1 может быть верным.'),
