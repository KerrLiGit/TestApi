...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Классификатор групп студентов';
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `FK_user_2` FOREIGN KEY (`group`) REFERENCES `group` (`group`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_user_3` FOREIGN KEY (`userid`) REFERENCES `result` (`userid`) ON DELETE CASCADE ON UPDATE CASCADE
