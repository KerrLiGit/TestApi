...
CREATE TABLE `group` (
  ...
  PRIMARY KEY (`groupid`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Классификатор групп студентов';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Пользователь';
...
INSERT INTO `user` (`userid`,`name`,`role`,`groupid`) VALUES 
 (6,'Николаев Павел Максимович','student',1);
